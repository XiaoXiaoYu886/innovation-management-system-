...
public class FileController {
    ...
    public R upload(@RequestParam("file") MultipartFile file, String type) {
        try {
            ...
            */
            FileUtils.copyFile(dest, new File("C:\\Users\\admin\\Desktop\\BiShe\\bishe\\daima\\springbootav3nz20q\\src\\main\\resources\\static\\upload"+"/"+fileName)); /**修改了路径以后请将该行最前面的//注释去掉**/
